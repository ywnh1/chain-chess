...
- **中断游戏可继续** — 异常退出/暂停中止（存活 >1 人）自动存为未完成记录，历史页显示「继续游戏」按钮
- **记录一次性消耗** — 继续旧记录后自动删除原记录，新对局结束后按最终状态生成新记录
...
<div align="center">
  <sub>Built with ♟ by <a href="https://github.com/nihao15900375400">ywnh1</a> · v2.3.5-beta</sub>
</div>
