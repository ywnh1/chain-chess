<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/version-3.1.1--beta-orange" alt="v3.1.1-beta">
  </p>
</div>
...
- **Rust + Rayon** — 除策略算法外均用 Rust 实现，Rayon 多核并行，深度 1~10 层可配置
- **交互切换** — 对局中可在弹窗一键切换算法、增减搜索深度，即时生效
...
- **结算图表** — 游戏结束后展示双折线图（棋子数 / 点数变化），支持全屏缩放
