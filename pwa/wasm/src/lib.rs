...
mod wasm_exports {
    ...
    pub fn process_move_cmd(json: &str) -> String {
        ...
        ok(&ProcessMoveResult { board: b, eliminated, killed_by, chain_count, game_over, winner })
    }
    ...
    pub fn ai_move_cmd(json: &str) -> String {
        ...
        let mv = match alg {
            ...
            "pvs" => find_best_move_pvs(&r.board, r.size, r.player, r.depth, &r.eliminated, r.max_players, r.game_count, use_ml, r.border_mode),
            ...
            _ => find_best_move(&r.board, r.size, r.player, r.depth, &r.eliminated, r.max_players, r.game_count, r.first_move_pos, use_ml, r.border_mode),
        };
        match mv {
            Some((x, y)) => ok(&[x, y]),
    ...
    pub fn engine_version() -> String {
        "chain-chess-engine-wasm-3.2.2".to_string()
    }
}
